...
public class Skyscraper {
    ...
    public Skyscraper(String name, String address, int numOfFloors, ArrayList<Integer> numOfRoomsPerFloor, IndustryType industryType) {
        this.name = name;
    ...
    public Boolean isIndustryGovernmentFunded() {
        return this.industryType == IndustryType.GOVERNMENT || this.industryType == IndustryType.EDUCATION || this.industryType == IndustryType.HEALTHCARE;
    }
    ...
    public String getBuildingInfo() {
        return "Skyscraper Name: " + name + "\n" +
               "Address: " + address + "\n" +
               "Number of Floors: " + numOfFloors + "\n" +
               "Rooms per Floor: " + numOfRoomsPerFloor.toString() + "\n" +
               "Is Open: " + isOpen + "\n" +
               "Industry Type: " + industryType + "\n" +
               "Total Number of Rooms: " + getTotalNumberOfRooms() + "\n" +
               "Government Funded: " + isIndustryGovernmentFunded();
    }
