...
export default function ProgramList()
{
    ...
    const programsTitles = ["Swine Short Loin", "Bacon Ipsum", "Picanha Swine Jowl", "Kevin Chicken T-Bone"]
    ...
    return (
        ...
        <ul className="programs">
          {programsTitles.map((title, index) => (
            <li className="program" key={index}>
              <Program title={title} description={programsDescriptions[index]} />
            </li>
          ))}
        </ul>
      </section>
