      ...
      <ul className="programs">
        <li className="program">
          ...
          <p>
            ...
            strip steak pork, swine boudin ham meatball meatloaf leberkas
            sausage. Turkey beef andouille kielbasa rump pastrami biltong
            chislic alcatra buffalo prosciutto jowl. Pastrami chicken sirloin
            swine capicola landjaeger jowl boudin pork chop shankle bresaola
            turducken leberkas ham.
          </p>
        </li>
        <li className="program">
          <h3>Bacon Ipsum</h3>
        ...
        <li className="program">
          ...
          <p>
            ...
            Jerky frankfurter fatback capicola hamburger, pork prosciutto
            bresaola ham porchetta rump t-bone pancetta tenderloin. Fatback ham
            hock prosciutto, tenderloin shoulder salami tri-tip leberkas bacon
        ...
        <li className="program">
          ...
          <p>
            ...
            sirloin pancetta pork loin shankle venison turducken boudin. Brisket
