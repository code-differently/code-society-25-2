...
class BankAtmBusinessAccountSupportTest {
  ...
  void testBankAtmSupportsBusinessCheckingAccount() {
    ...
    Set<CheckingAccount> businessCustomerAccounts = atm.findAccountsByCustomerId(businessCustomer.getId());
    Set<CheckingAccount> regularCustomerAccounts = atm.findAccountsByCustomerId(regularCustomer.getId());
