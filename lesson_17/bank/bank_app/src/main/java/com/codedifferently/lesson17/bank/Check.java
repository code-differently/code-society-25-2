...
public class Check {
  ...
  /**
   * Gets the amount on the check. This method was added to support the BusinessCheckingAccount and
   * SavingsAccount implementations, allowing the CheckingAccount class to access the check amount
   * during check processing while maintaining encapsulation of the amount field.
   *
