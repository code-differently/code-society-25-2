...
/**
 * Represents a bank account interface. Defines the common operations that all account types must
 * support.
 */
public interface Account {
  ...
  void withdraw(double amount)
      throws com.codedifferently.lesson17.bank.exceptions.InsufficientFundsException;
