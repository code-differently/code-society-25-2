 ...
 * 
 * <p>This class provides exchange rate conversion functionality to support
 * multi-currency deposits in the banking system. All conversions are to USD
 * as the base currency for account balance management.
 * 
 * <p>Exchange rates are simplified for demonstration purposes and represent
 * approximate values. In a production system, these would be sourced from
...
public class CurrencyConverter {
   ...
   * 
   * <p>Exchange rates are initialized with approximate values for demonstration.
   * USD is the base currency with a rate of 1.0.
   */
   ...
   * 
   * <p>The conversion uses the current exchange rates stored in this converter.
   * If the source currency is USD, the amount is returned unchanged.
   * 
   ...
   * 
   * <p>These are simplified rates for demonstration purposes.
   * In production, rates would be fetched from financial data providers.
   */
