...
public class SavingsAccount extends CheckingAccount {
  ...
  /**
     * Overrides the check processing functionality to prevent checks from being used with savings accounts.
     * This implementation fulfills the requirement that savings accounts cannot process checks by
     * throwing an UnsupportedOperationException whenever check processing is attempted.
     *
