 ...
 * type extends the regular checking account but adds validation to ensure that at least one of the
 * account owners is a business entity.
 */
public class BusinessCheckingAccount extends CheckingAccount {
  /**
   * Creates a new business checking account with the specified account number, owners, and initial
   * balance. Validates that at least one owner is a business entity.
   *
