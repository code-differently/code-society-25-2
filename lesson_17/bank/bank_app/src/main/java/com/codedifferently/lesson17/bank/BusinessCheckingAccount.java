...
public class BusinessCheckingAccount extends CheckingAccount {
  ...
  public BusinessCheckingAccount(
      String accountNumber, String businessName, BusinessCustomer businessCustomer) {
    super(accountNumber, new HashSet<>(), 0.0);
  ...
  public boolean hasBusinessCustomers() {
    return getCustomers().stream().anyMatch(customer -> customer instanceof BusinessCustomer);
  }
  ...
  public void addCustomer(Customer customer) {
    if (customer instanceof BusinessCustomer) {
      ...
      throw new IllegalArgumentException(
          "Business checking accounts can only have business customers");
    }
  }
