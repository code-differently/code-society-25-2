...
public class SampleFileGenerator {
   ...
   * @param mode - Determines how data is generated. - "single": Uses a shuffled/random set of value
   *     generators. - "bulk": Uses a strict ordered set of value generators matching schema.
