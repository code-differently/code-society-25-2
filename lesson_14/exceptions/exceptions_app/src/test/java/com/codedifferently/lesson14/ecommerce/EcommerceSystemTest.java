...
class EcommerceSystemTest {
  ...
  @Test
  void testRefundNonRefundableProductThrows()
      throws InvalidCategoryException, InvalidProductException, OutOfStockException {
  ...
  @Test
  void testRefundRefundableProductRestoresStock()
      throws InvalidCategoryException,
          InvalidProductException,
          OutOfStockException,
          NonRefundableProductException {
  ...
  @Test
  void testSetShippingAddressInvalidCountryThrows()
      throws InvalidCategoryException, InvalidProductException, OutOfStockException {
  ...
  @Test
  void testSetShippingAddressInvalidStateThrows()
      throws InvalidCategoryException, InvalidProductException, OutOfStockException {
  ...
  void testPartialRefundNotAllowedException() {
    ...
    assertThatThrownBy(() -> ecommerceSystem.refundPartialOrder(missingItems))
        ...
        .hasMessageContaining(
            "Partial refunds are not allowed. Missing items for complete refund: item1, item2");
  }
}
